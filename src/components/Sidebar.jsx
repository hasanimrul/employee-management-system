...
const Sidebar = () => {
  ...
  return (
    <div>
      <div className="relative flex flex-col border border-t-0 border-dotted border-gray-300 dark:border-gray-700 dark:hover:border-sky-800 rounded">
        <button className="absolute top-3 right-3 lg:hidden">
          <svg
            width="25px"
            height="25px"
            viewBox="0 0 24 24"
